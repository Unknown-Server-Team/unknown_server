...
class AuthAnalytics {
    ...
    async trackRoleUsage(roleId, userId) {
    ...
    async trackPermissionUse(permissionId, userId) {
    ...
    async getAuditLog(filters = {}, pagination = { page: 1, limit: 20 }) {
        const conditions = [];
        const params = [];
    ...
    async getRoleAnalytics(roleId = null) {
    ...
    async getPermissionAnalytics(permissionId = null) {
    ...
    async getMostUsedRoles(limit = 10) {
    ...
    async getMostUsedPermissions(limit = 10) {
    ...
    async generateAnalyticsReport(from, to) {
...
module.exports = new AuthAnalytics();